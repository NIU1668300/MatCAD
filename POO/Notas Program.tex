...
\begin{document}
    ...
    \label{sec:principios_de_diseño}
       ...
       \subsection{LSP: Principio de substitución de Liskov} % (fold)
        ...
        \subsection{Program to an interface, not an implementation} % (fold)
        ...
        % subsection program_to_an_interface_not_an_implementation
    % section lsp (end)
    ...
    \section{Patrones de diseño} % (fold)
    ...
    % section patrones_de_diseño (end)
\end{document}